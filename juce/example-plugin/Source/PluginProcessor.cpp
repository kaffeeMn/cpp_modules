 ...
 *      () document window:
 *      + containing
 *          - turning knob for volume values in [0,1]
 *
 *      () audio output:
 *      + random values in [0,1] for white noise
 */
...
int NewProjectAudioProcessor::getNumPrograms()
{
     ...
     * 0 programs,so this should be at least 1, even if you're not really 
...
void NewProjectAudioProcessor::changeProgramName
(int index, const String& newName){
}

void NewProjectAudioProcessor::prepareToPlay
